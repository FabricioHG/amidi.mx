 ...
 *
 * @Block(
 *   id = "udg_liston_watsapp_contacto",
 *   admin_label = @Translation("Whatsapp contacto"),
 *   category = @Translation("Whatsapp")
 * )
 */
...
Use: 3342993438.'),
  ...
  public function build() {
    ...
    if ($this->moduleHandler->moduleExists('udg_liston')) {
      $module_path = $this->moduleHandler->getModule('udg_liston')->getPath();
    }
    
    $image_url ='/'.$module_path.'/images/whatsApp_icon.png';
    ...
    $build['#attached']['library'][] = 'udg_liston/udg_liston';
